#!/usr/bin/env bash
# Train/eval launcher: low-latency streaming hybrid Mamba+Attention model
...
exp=exp/hybrid_mamba_attention_low_latency
asr_config=conf/streaming_hybrid_mamba_attention_low_latency.yaml
inference_config=conf/inference_hybrid_mamba_attention_low_latency.yaml
inference_args="--ctc_weight 0.6"
