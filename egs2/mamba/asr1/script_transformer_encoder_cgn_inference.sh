...
export CUDA_HOME=/esat/audioslave/r0883470/miniconda3/envs/cuda128_copy
...
SHARED_RUN_DIR=$(pwd)
SHARED_ASR_EXP="${SHARED_RUN_DIR}/exp/asr_streaming_transformer_raw_nl_bpe5000"
...
:
EOF
        LOCAL_ASR_EXP="${LOCAL_RECIPE_DIR}/exp/asr_streaming_transformer_raw_nl_bpe5000"
...
test_sets="val_cased_cleaned_small" #in quotation marks because multiple can be given seperated by a space
...
exp=exp/cgn_transformer_encoder
...
inference_args="--ctc_weight 1.0 --sim_chunk_length 2048"
